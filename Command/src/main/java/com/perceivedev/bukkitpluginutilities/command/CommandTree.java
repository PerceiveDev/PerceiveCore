...
import com.perceivedev.bukkitpluginutilities.utilities.disable.DisableListener;
...
public class CommandTree {
     ...
     * <p>
     * Uses {@link CorePlugin}s DisableManager
     *
     * @see #CommandTree(DisableManager)
     */
    @SuppressWarnings("unused")
    public CommandTree() {
        this(CorePlugin.getInstance().getDisableManager());
    }
