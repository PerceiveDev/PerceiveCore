...
import com.perceivedev.bukkitpluginutilities.command.argumentmapping.ArgumentMapper;
import com.perceivedev.bukkitpluginutilities.command.argumentmapping.ArgumentMappers;
import com.perceivedev.bukkitpluginutilities.command.argumentmapping.ConvertedParams;
...
import com.perceivedev.bukkitpluginutilities.reflection.ReflectionUtil.Modifier;
    ...
    private CommandResult invokeMappedMethod(CommandSender sender, String... args) {
        ...
        if (!response.isValuePresent()) {
            if (response.getResultType() == ReflectResponse.ResultType.ERROR) {
                ...
                CorePlugin.getInstance().getLogger().log(Level.WARNING, "Command returned null! ", new Throwable());
            }
            return CommandResult.ERROR;
        }
