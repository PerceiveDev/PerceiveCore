...
/**
 * The ConfigManager class allows dynamic saving and loading of data classes to YAML config files. This class can have
 * it's functionality extended by adding new {@link ISerializationHandler} with
...
public class ConfigManager {
	...
	YamlConfiguration config = getOrCreate(path);
    ...
    private Map<String, Object> serialize(Object o) {
    ...
    /**
     * Attempts to deserialize the data provided in the context of the given class
     *
     * @param clazz the class to deserialize to
     * @param data the data provided
     *
     * @return The data loaded into an instance of the class, or null if something went wrong
     */
    @SuppressWarnings("unchecked")
    private Object deserialize(Class<? extends Object> clazz, Map<String, Object> data) {
    ...
    @SuppressWarnings("unchecked")
    private boolean saveToConfig(YamlConfiguration config, Map<String, Object> map) {
    ...
    @SuppressWarnings("unchecked")
    private void saveToConfig(ConfigurationSection section, Map<String, Object> map) {
