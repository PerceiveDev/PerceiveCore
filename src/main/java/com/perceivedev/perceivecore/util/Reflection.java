...
public class Reflection {
    ...
    public static List<Field> getFieldsWithAnnotation(Class<? extends Object> clazz, Class<? extends Annotation>
            annotation) {
    ...
    public static void setValue(Field f, Object o, Object v) {
        ...
        try {
            ...
            System.err.println("Failed to set value of field '" + f.getName() + "' in class '" + o.getClass()
                    .getCanonicalName() + "'");
            e.printStackTrace();
        }
